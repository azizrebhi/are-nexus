...
const Dashboard = () => {
  ...
  // Filter members based on search query (search in all fields)
    ...
    <div className="min-h-screen text-white px-6 sm:px-10 py-10">
      <div className="flex justify-between items-center mb-10">
        ...
        <input
          ...
          className="px-4 py-2 rounded bg-neutral-800 border border-neutral-600 text-white focus:outline-none focus:ring-2 focus:ring-[#E2AC0D]"
        />
      </div>
